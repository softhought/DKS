                    ...
                    <label for="profilepic"></label>
                     ...
                     <div class="inputWrapper">
                        ...
                        <label class="btn  btn-default btn-flat">Upload Photo 
                         ...
                         <input type="hidden" name="mem_image" id="mem_image" value="<?php if($bodycontent['mode'] == 'EDIT' && $bodycontent['memberEditdata']->image_name != ''){  echo $bodycontent["memberEditdata"]->image_name; } ?>">
          ...
          <div class="formblock-box"> 
           ...
           <div class="formblock-box"> 
            ...
            <div class="col-md-8 infosection">
                   ...
                   <div class="col-md-5 uploadProfile">

                          <label for="profilepic"></label>
                           
                          <div class="form-group profile-block">

                              <img src='<?php if($bodycontent['mode'] == 'EDIT' && $bodycontent['memberEditdata']->spouse_image != ''){ ?> <?php echo base_url(); ?>assets/img/member-images/<?php echo $bodycontent["memberEditdata"]->spouse_image; } ?>' id="spouseshowimage" style="width: 120px;height:125px;border: 1px solid #6d78cb;margin-bottom:13px;margin-right: 34px; ">

                              <img src='<?php if($bodycontent['mode'] == 'EDIT' && $bodycontent['memberEditdata']->spouse_sign_image != ''){ ?> <?php echo base_url(); ?>assets/img/member-images/<?php echo $bodycontent["memberEditdata"]->spouse_sign_image; } ?>' id="spousesignimage" style="width: 120px;height:125px;border: 1px solid #6d78cb;margin-bottom:13px;" >

                          <div class="inputWrapper">

                              <label class="btn  btn-default btn-flat" style="margin-right: 51px;">Upload Photo 

                                <input class="fileInput"  type='file' custom-file-input name='spouseimagefile' id="spouseimagefile" size='20' onchange="readCommanURL(this);" data-showId="spouseshowimage"   data-isimage="isspouseImage"style="display: none;" accept="image/*" value="<?php if($bodycontent['mode'] == 'EDIT' && $bodycontent['memberEditdata']->spouse_image != ''){  echo $bodycontent["memberEditdata"]->spouse_image; } ?>">


                              </label>
                              <input type="hidden" name="spouse_image" id="spouse_image" value="<?php if($bodycontent['mode'] == 'EDIT' && $bodycontent['memberEditdata']->spouse_image != ''){  echo $bodycontent["memberEditdata"]->spouse_image; } ?>">
                              <label class="btn  btn-default btn-flat">Upload Sign 

                                    <input class="fileInput"  type='file' custom-file-input name='spousesignimagefile' id="spousesignimagefile" size='20' onchange="readCommanURL(this);" data-showId="spousesignimage" data-isimage="IsSpouseSign" style="display: none;" accept="image/*" value="<?php if($bodycontent['mode'] == 'EDIT' && $bodycontent['memberEditdata']->spouse_sign_image != ''){  echo $bodycontent["memberEditdata"]->spouse_sign_image; } ?>">


                                    </label>
                                    <input type="hidden" name="spouse_signimage" id="spouse_signimage" value="<?php if($bodycontent['mode'] == 'EDIT' && $bodycontent['memberEditdata']->spouse_sign_image != ''){  echo $bodycontent["memberEditdata"]->spouse_sign_image; } ?>">

                              <input type='hidden' name='isspouseImage' id="isspouseImage" value="N">
                              <input type='hidden' name='IsSpouseSign' id="IsSpouseSign" value="N">
   ...
   <div class="modal-body">
      <div class="row">
         ...
         <div class="form-group profile-block">
             ...
             <img src='<?php if($bodycontent['mode'] == 'EDIT' && $memberchildtl->image != ''){ ?> <?php echo base_url(); ?>assets/img/children-images/<?php echo $memberchildtl->image; } ?>' id="childrenshowimage_<?php echo $rowno; ?>" style="width: 120px;height:125px;border: 1px solid #6d78cb;margin-bottom:13px;margin-right: 34px; ">

             <img src='<?php if($bodycontent['mode'] == 'EDIT' && $memberchildtl->sign_image != ''){ ?> <?php echo base_url(); ?>assets/img/children-images/<?php echo $memberchildtl->sign_image; } ?>' id="childrensignimage_<?php echo $rowno; ?>" style="width: 120px;height:125px;border: 1px solid #6d78cb;margin-bottom:13px; ">
         ...
         <div class="inputWrapper">
             ...
             <input type="hidden" name="child_image[]" id="child_image_<?php echo $rowno; ?>" value="<?php if($bodycontent['mode'] == 'EDIT' && $memberchildtl->image != ''){  echo $memberchildtl->image; } ?>">
             ...
             <label class="btn  btn-default btn-flat">Upload Sign 
                 ...
                 <input type="hidden" name="childsign_image[]" id="childsign_image_<?php echo $rowno; ?>" value="<?php if($bodycontent['mode'] == 'EDIT' && $memberchildtl->sign_image != ''){  echo $memberchildtl->sign_image; } ?>">
