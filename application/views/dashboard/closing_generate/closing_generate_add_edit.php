<script src="<?php echo base_url(); ?>assets/js/customJs/closing/closing_bill_tennis.js"></script>
...
<section class="layout-box-content-format1">
        ...
        <div class="card card-primary">
            ...
            <div class="card-header box-shdw">
              ...
              <h3 class="card-title">Tennis - Closing Generation</h3>
           ...
           <form name="closingGenerateFrom" id="closingGenerateFrom" enctype="multipart/form-data">
        ...
        <div class="col-md-2" id="monthblock">
              ...
              <div class="col-md-2">
                 ...
                 <div class="form-group">
                           ...
                           " id="closinggeneratebtn">Generate</button>
