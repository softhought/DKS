                            ...
                            <label for="code">Time Slot</label>
                             ...
                             <div class="input-group input-group-sm" id="sel_time_sloterr">
                              ...
                              <option value="<?php echo $timeslotlist->time_slot_id;?>"
                               ...
                               <?php if($bodycontent['mode'] == 'EDIT'){
                                  if ($bodycontent['transactionEditdata']->time_slot_id==$timeslotlist->in_hour) {
                                   echo "selected";
                                  }
                                } 
                               ?>
                      ...
                      <div class="col-md-1">
                          <div class="form-group">
                            <label for="firstname">Court No</label>
                              <div class="input-group input-group-sm">
                            <input type="text" class="form-control forminputs " id="court_no" name="court_no" placeholder="" autocomplete="off"  onKeyUp="numericFilter(this);" value="<?php if($bodycontent['mode'] == 'EDIT'){echo $bodycontent['transactionEditdata']->court_no;}?>" >
                            </div>
