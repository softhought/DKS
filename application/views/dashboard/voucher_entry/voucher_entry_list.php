  ...
  <section class="layout-box-content-format1">
        <div class="card card-primary">
            ...
            <div class="card-header box-shdw">
              <h3 class="card-title">Voucher Entry Register</h3>
            ...
            <div class="list-search-block">
               <div class="row box">
                ...
                <div class="col-md-2">
                 <button type="button" class="btn btn-block action-button btn-sm" id="voucherentryshowbtn" style="width: 60%;">Show</button>
    ...
    <tbody>
           <?php if($bodycontent['voucherentryList']){
               $j=1;
               foreach($bodycontent['voucherentryList'] as $content){?>
        <tr>
                <td><?php echo $j++;?></td>
              ...
              <a href="<?php echo base_url(); ?>voucherentry/addVoucher/<?php echo $content['id']; ?>" class="btn tbl-action-btn padbtn">
