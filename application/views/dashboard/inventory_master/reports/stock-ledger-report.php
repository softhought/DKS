<script src="<?php echo base_url(); ?>assets/js/customJs/inventory/reports/stock_ledger.js"></script>
<style type="text/css">
...
<section class="layout-box-content-format1">
        <div class="card card-primary">
           ...
           <form name="stockledgerForm" id="stockledgerForm" target="_blank">
            ...
            <div id="copy_div">
             ...
             <div class="row">
              ...
              <div class="col-md-2">
                 ...
                 <tbody>
                     <?php $row = 1;
                     foreach($bodycontent['rowmaterialList'] as $rowmaterialList){ ?>
                      <tr>                      
                      <td><?php echo $rowmaterialList->name; ?></td>
                      <td align="center">
                  <input type="hidden" name="row_material_id_<?php echo $row;?>" id="row_material_id_<?php echo $row;?>" value="<?php echo $rowmaterialList->raw_meterial_id;?>" >
              ...
              <div class="col-md-2">
                 <div class="form-group">
                           ...
                           " id="stockledgerbtn">View Report</button>
                            </div>
