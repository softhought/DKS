<script src="<?php echo base_url(); ?>assets/js/customJs/inventory/purchase_order_register.js"></script>
<style type="text/css">
...
<section class="layout-box-content-format1">
        <div class="card card-primary">
           ...
           <form name="purchaseorderregForm" id="purchaseorderregForm" target="_blank">
             ...
             <div class="row">
              ...
              <div class="col-md-2">
                 <div class="form-group">
                           ...
                           " id="purchaseprint">View Report</button>
                            </div>
