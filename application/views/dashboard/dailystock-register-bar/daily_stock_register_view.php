<script src="<?php echo base_url(); ?>assets/js/customJs/dailystock-register-bar/dailystockregisterbar.js"></script>
<section class="layout-box-content-format1">

        <div class="card card-primary">
            <div class="card-header box-shdw">
              <h3 class="card-title">Daily Stock Register (Bar)</h3>
