<script src="<?php echo base_url(); ?>assets/js/customJs/payroll/reports/salary_register.js"></script>
 ...
 <style> 
       ...
       <form name="salaryregisterFrom" id="salaryregisterFrom" method="post" action="<?php echo base_url(); ?>salaryregister/print_salaryregister"  target="_blank">
            ...
            <div class="card-header box-shdw">
              <h3 class="card-title">Salary Register</h3>
 ...
 <fieldset class="scheduler-border formblock-box">
               ...
               <div class="col-md-3" >
                     ...
                     <div class="form-group">
                            ...
                            <div class="input-group input-group-sm">
                              <button type="button" class="btn btn-block action-button btn-sm noprint" id="salaryregistershw" >Show</button>
                            </div>
                          </div>
              </div> 
