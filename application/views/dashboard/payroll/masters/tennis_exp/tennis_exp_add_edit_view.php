<script src="<?php echo base_url(); ?>assets/js/customJs/payroll/masters/tennisexp.js"></script>

<section class="layout-box-content-format1">
        <div class="card card-primary">
            <div class="card-header box-shdw">
              <h3 class="card-title">Tennis Exp.</h3>
               <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" >
               <a href="javascript:;" class="btn btn-info btnpos" id="tenniscopybtn">
              <i class="fas fa-copy"></i><span id="cpspan"> Copy </span></a>

              <a href="<?php echo base_url(); ?>tennisexp" class="btn btn-info btnpos">
           ...
           <form name="tennisexpFrom" id="tennisexpFrom" enctype="multipart/form-data">

           <input type="hidden" name="mode" id="mode" value="<?php echo $bodycontent['mode']; ?>">
           <input type="hidden" name="tennisexpID" id="tennisexpID" value="<?php echo $bodycontent['tennisexpID']; ?>">
                            ...
                            <div class="input-group input-group-sm" id="sel_montherr">
                              ...
                              <option value="<?php echo $monthlist->id; ?>"
                                <?php if($bodycontent['mode']=='EDIT'){
                                  ...
                                  if ($bodycontent['tennisexpEditdata']->month_id==$monthlist->id) {
                                      echo "selected";
                                  }
                            ...
                            <div class="input-group input-group-sm" id="employeeerr">
                              ...
                              <option value="<?php echo $employeelist->empl_id; ?>"
                                <?php if($bodycontent['mode']=='EDIT'){
                                  ...
                                  if ($bodycontent['tennisexpEditdata']->employee_id==$employeelist->empl_id) {
                                      echo "selected";
                                  }
               ...
               <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control forminputs " id="amount" name="amount" placeholder="" autocomplete="off" value="<?php if($bodycontent['mode']=='EDIT'){
                              echo $bodycontent['tennisexpEditdata']->amount;
                 ...
                 <div class="col-md-2 text-right">
                   ...
                   <label for="firstname">&nbsp; </label>
                      <div class="input-group input-group-sm" id="amounterr">
                 <button type="submit" class="btn btn-sm action-button" id="tennisexpbtn" style="width: 60%;"><?php echo $bodycontent['btnText']; ?></button>
              ...
              <div class="col-md-2"></div>
               <div class="col-md-2">
                ...
                <div class="col-md-2">
                   ...
                   <label for="firstname">&nbsp; </label>
                      <div class="input-group input-group-sm" id="amounterr">
                 <button type="button" class="btn btn-sm action-button" id="tennisexpCopybtn" style="width: 60%;">copy</button>
