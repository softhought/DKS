                   ...
                   <h3 class="form-block-subtitle"><i class="fas fa-angle-double-right"></i>Department Info</h3>  
                         ...
                         <div class="row">
                           <div class="col-md-4"></div>
                            ...
                            <div class="col-md-4"></div>
                              <div class="col-md-4">
                                 <label for="dept_name">Department Code(Non Editable)</label>
                                     <div class="form-group">
                                         <div class="input-group input-group-sm">
                                              <input type="text" class="form-control" name="dept_code" id="dept_code" placeholder="Enter Department Code" style="text-transform:uppercase;" value="<?php if($bodycontent['mode'] == 'EDIT'){ echo $bodycontent['departmentEditdata']->dept_code; } ?>" 
                                             >
