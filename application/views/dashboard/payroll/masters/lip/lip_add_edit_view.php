<script src="<?php echo base_url(); ?>assets/js/customJs/payroll/masters/lip.js"></script>

<section class="layout-box-content-format1">
        <div class="card card-primary">
            <div class="card-header box-shdw">
              <h3 class="card-title">LIP</h3>
               <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" >
               <a href="javascript:;" class="btn btn-info btnpos" id="lipcopybtn">
              <i class="fas fa-copy"></i><span id="cpspan"> Copy </span></a>

              <a href="<?php echo base_url(); ?>lip" class="btn btn-info btnpos">
           ...
           <form name="LipFrom" id="LipFrom" enctype="multipart/form-data">

           <input type="hidden" name="mode" id="mode" value="<?php echo $bodycontent['mode']; ?>">
           <input type="hidden" name="lipID" id="lipID" value="<?php echo $bodycontent['lipID']; ?>">
            ...
            <div id="add_div">
             ...
             <div class="row">
              ...
              <div class="col-md-1"></div>
                            ...
                            <div class="input-group input-group-sm" id="sel_montherr">
                              ...
                              <option value="<?php echo $monthlist->id; ?>"
                                <?php if($bodycontent['mode']=='EDIT'){
                                  ...
                                  if ($bodycontent['lipEditdata']->month_id==$monthlist->id) {
                                      echo "selected";
                                  }
                            ...
                            <div class="input-group input-group-sm" id="employeeerr">
                              ...
                              <option value="<?php echo $employeelist->empl_id; ?>"
                                <?php if($bodycontent['mode']=='EDIT'){
                                  ...
                                  if ($bodycontent['lipEditdata']->employee_id==$employeelist->empl_id) {
                                      echo "selected";
                                  }
               ...
               <div class="col-md-2">
                          <div class="form-group">
                            <label for="firstname">Lip Amount </label>
                            <div class="input-group input-group-sm" id="amounterr">
                            <input type="text" class="form-control forminputs " id="amount" name="amount" placeholder="" autocomplete="off" value="<?php if($bodycontent['mode']=='EDIT'){
                              echo $bodycontent['lipEditdata']->lip_amount;
                 ...
                 <div class="col-md-2 text-right">
                   ...
                   <label for="firstname">&nbsp; </label>
                      <div class="input-group input-group-sm" id="amounterr">
                 <button type="submit" class="btn btn-sm action-button" id="lipsavebtn" style="width: 60%;"><?php echo $bodycontent['btnText']; ?></button>
              ...
              <div class="col-md-2"></div>
               <div class="col-md-2">
                ...
                <div class="col-md-2">
                   ...
                   <label for="firstname">&nbsp; </label>
                      <div class="input-group input-group-sm" id="amounterr">
                 <button type="button" class="btn btn-sm action-button" id="lipCopybtn" style="width: 60%;">copy</button>
