                         ...
                         <div class="col-md-4"></div>
                              <div class="col-md-4">
                                 <label for="dept_name">Cheque No</label>
                                     <div class="form-group">
                                         <div class="input-group input-group-sm">
                                              <input type="text" class="form-control" name="cheque_no" id="cheque_no" placeholder="Enter Cheque No"  value="<?php if($bodycontent['mode'] == 'EDIT'){ 
                                                 echo $bodycontent['chequeno'];
