  ...
  <section class="layout-box-content-format1">
        <div class="card card-primary">
            ...
            <div class="card-header box-shdw">
              <h3 class="card-title">Wastage Register</h3>
               <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" >
                  <a href="<?php echo base_url(); ?>wastage/addWastage" class="btn btn-info btnpos">
            ...
            <div class="list-search-block">
              ...
              <table class="table customTbl table-bordered table-striped dataTable">
                ...
                $total=0;
                $i=1;
                foreach ($bodycontent['wastageList'] as $wastagelist) { 
               
                   
                  ?>
                   <tr>
                   <td><?php echo $i++; ?></td>
                   <td><?php echo $wastagelist->transaction_no; ?></td>
                   <td><?php echo date("d-m-Y", strtotime($wastagelist->transaction_dt)); ?></td>
                   
                   <td>
                         <a href="<?php echo base_url(); ?>wastage/addWastage/<?php echo $wastagelist->wastage_id; ?>" class="btn tbl-action-btn padbtn">
