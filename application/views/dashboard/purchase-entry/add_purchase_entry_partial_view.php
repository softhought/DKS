    ...
    <tr id="rowpurchasedetails_<?php echo $rowno; ?>" class="childDtlCls" >
      ...
      <input type="hidden" name="purchaseentryId[]" id="purchaseentryId_<?php echo $rowno; ?>" value="0"> 
      <input type="hidden" name="purchasestock[]" id="purchasestock_<?php echo $rowno; ?>" value="<?php echo $stock_in_hand; ?>"> 
      <input type="hidden" name="purchaseunit[]" id="purchaseunit_<?php echo $rowno; ?>" value="<?php echo $unit_id; ?>"> 
    ...
    <td style="text-align: left;width: 20%">
       <div class="form-group dispblock_<?php echo $rowno; ?>" style="display: none;">
            <div class="input-group input-group-sm"> 
                <input type="hidden" class="form-control editchilddtl_<?php echo $rowno; ?>" name="childpass_no[]" id="childpass_no_<?php echo $rowno; ?>" value="<?php echo $pass_no;?>"> 
             </div>
         </div>         
     <span class="showdata_<?php echo $rowno; ?>"><?php echo $pass_no;?> </span>                  
    </td>
    <td style="text-align: left;width: 20%">
       <div class="form-group dispblock_<?php echo $rowno; ?>" style="display: none;">
            <div class="input-group input-group-sm"> 
                <input type="hidden" class="form-control editchilddtl_<?php echo $rowno; ?>" name="childbatch_no[]" id="childbatch_no_<?php echo $rowno; ?>" value="<?php echo $batch_no;?>"> 
             </div>
         </div>         
     <span class="showdata_<?php echo $rowno; ?>"><?php echo $batch_no;?> </span>                  
    </td>
    <td style="text-align: left;width: 20%">
       <div class="form-group dispblock_<?php echo $rowno; ?>" style="display: none;">
            <div class="input-group input-group-sm"> 
...
<script type="text/javascript">
    ...
    $(document).on("change keyup", ".calconml", function() {
       ...
       // $("#childconve_"+rownum).val(liquer_vol * quantity);
