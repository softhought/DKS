...
<section class="layout-box-content-format1">
        <div class="card card-primary">
            <div class="card-header box-shdw">
              <h3 class="card-title">Benvolent Fund</h3>
              ...
              <a href="<?php echo base_url(); ?>benvolentfund" class="btn btn-info btnpos">
           ...
           <form name="benvolentFrom" id="benvolentFrom" enctype="multipart/form-data">
             ...
             <div class="row">
              ...
              <div class="col-md-1 text-right">
                 <div class="form-group">
                            ...
                            <div class="input-group input-group-sm">
                           <button type="submit" class="btn btn-sm action-button" id="benvolentbtn">View</button>
                            </div>
               ...
               <div class="col-md-2">
                 <div class="form-group">
                            <label for="specialcoching">&nbsp;</label>
                            <div class="input-group input-group-sm">
                           <button type="submit" class="btn btn-sm action-button" id="benvolentAmountApplybtn">Apply</button>
                            </div>
               ...
               <div class="col-md-2">
                ...
                <div class="col-md-2">
                 ...
                 <div class="form-group">
                            <label for="specialcoching">&nbsp;</label>
                            <div class="input-group input-group-sm">
                           <button type="submit" class="btn btn-sm action-button" id="benvolentCopybtn">Copy</button>
                            </div>
