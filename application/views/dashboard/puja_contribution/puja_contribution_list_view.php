        ...
        <div class="card card-primary">
           ...
           <div class="list-summary">
            ...
            <div class="card-header box-shdw">
              <h3 class="card-title">Puja Contribution - List</h3>
              <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" >
              <a href="<?php echo base_url(); ?>pujacontribution/addContribution" class="btn btn-info btnpos">
            ...
            <div id="pujacontributionlist">
              <table  class="table customTbl table-bordered table-hover dataTable  tablepad">
                ...
                <?php $i=1;$total=0;
                foreach ($bodycontent['pujacontributionList'] as $pujacontributionlist) { 
