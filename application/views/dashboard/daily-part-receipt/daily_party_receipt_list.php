  ...
  <section class="layout-box-content-format1">
        <div class="card card-primary">
            ...
            <div class="card-header box-shdw">
              <h3 class="card-title">Daily Party Receipt Register</h3>
            ...
            <div class="list-search-block">
               <div class="row box">
                ...
                <label for="payment">&nbsp;</label>
                 <button type="button" class="btn btn-block action-button btn-sm" id="dailypartyreceiptshowbtn" style="width: 60%;">Show</button>
