...
<script src="<?php echo base_url();?>assets/jstree/jstree.js"></script>
<script src="<?php echo base_url();?>assets/js/customJs/menupermission.js"></script>
...
div.bhoechie-tab-menu div.list-group > a.active, div.bhoechie-tab-menu div.list-group > a.active .glyphicon, div.bhoechie-tab-menu div.list-grou
{
                        ...
                        <div class="row bhoechie-tab-container">
                                <div class="col-lg-3 col-lg-33 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
                                    <div class="list-group">                                        
                                        <?php foreach ($bodycontent['userslist'] as $user) { ?>
                                               ...
                                               <?php if(sizeof($bodycontent['Menulist'])>0)  {
                                                    foreach($bodycontent['Menulist'] as $firstlevel) { 
                                                        if(sizeof($firstlevel['secondLevelMenu'])>0) {  ?>
                                                            <li id="<?php echo $firstlevel['FirstLevelMenuData']->id;?>"><?php echo $firstlevel['FirstLevelMenuData']->name;?>  
                                                                <ul>
                                                                <?php foreach($firstlevel['secondLevelMenu'] as $second_lvl)    {     
                                                                        if(sizeof($second_lvl['thirdLevelMenu'])>0){ ?>
                                                                            <li id="<?php echo $second_lvl['secondLevelMenuData']->id; ?>"><?php echo $second_lvl['secondLevelMenuData']->name; ?>
                                                                                <ul>
                                                                                    <?php foreach($second_lvl['thirdLevelMenu'] as $third_lvl) { ?>                
                                                                                        <li id="<?php echo $third_lvl['thirdLevelMenuData']->id; ?>"><?php echo $third_lvl['thirdLevelMenuData']->name; ?></li>      
                                                                                    <?php } ?>
                                                                                </ul>
                                                                            </li>
                                                                           <?php }else{ ?>
                                                                            <li id="<?php echo $second_lvl['secondLevelMenuData']->id;?>"><?php echo $second_lvl['secondLevelMenuData']->name;?></li>
                                                                           <?php }
                                                                    } ?>
                                                                </ul>
                                                            </li>        
                                                                <?php }else { ?>
                                                            <li id="<?php echo $firstlevel['FirstLevelMenuData']->id; ?>"><?php echo$firstlevel['FirstLevelMenuData']->name; ?></li>
                                                    <?php }
                                                            }
                                                            }?> 
                                    </ul>
