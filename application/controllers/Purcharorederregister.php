...
class Purcharorederregister extends CI_Controller {
...
public function index()
{
  ...
  $session = $this->session->userdata('user_detail');
	...
	{  
          $page = "dashboard/inventory_master/reports/purchage-report-register";
        $header="";       
...
public function purchaseorderregisterreport()
{
    $session = $this->session->userdata('user_detail');
    if($this->session->userdata('user_detail'))
    {            
       ...
       $arrayParameter=[
        ...
        $file= APPPATH."views/dashboard/reports/purchase-order-register/PurchaseOrderReport.jrxml";
