...
class Stockledgerreport extends CI_Controller {
...
public function index()
{
  ...
  $session = $this->session->userdata('user_detail');
	...
	{  
          $page = "dashboard/inventory_master/reports/stock-ledger-report";
        $header="";       
...
public function stockledgerreport()
{
    ...
    {            
       ...
       $arrayParameter=[
        ...
        $file= APPPATH."views/dashboard/reports/stock-ledger-report/StockLedgerReport.jrxml";
