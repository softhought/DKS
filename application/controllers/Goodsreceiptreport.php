...
class Goodsreceiptreport extends CI_Controller {
...
public function index()
{
  ...
  $session = $this->session->userdata('user_detail');
	...
	{  
          $page = "dashboard/inventory_master/reports/goods-receipt-register";
        $header="";       
...
public function goodsreceiptreport()
{
    $session = $this->session->userdata('user_detail');
    if($this->session->userdata('user_detail'))
    {            
       ...
       $arrayParameter=[
            'form_date'=>"'". $frmDate."'",
            'to_date'=>"'". $toDt."'",
            'vender_id'=>urldecode($this->uri->segment(5)),
            'YearId'=>$yearid ,
        ...
        $file= APPPATH."views/dashboard/reports/goods-receipt-report/GoodsReceiptReport.jrxml";
        ...
        $jasperphp->outpage('I','GoodsReceipt-'.$Date.'.pdf');   
        // pre($jasperphp);     
