...
class Maingroupinv extends CI_Controller {
...
public function index()
{
  $session = $this->session->userdata('user_detail');
	...
	{  
        $page = "dashboard/inventory_master/main_group/main_group_list_view";
        $header="";  
  
        $result['maingroupList'] = $this->commondatamodel->getAllRecordOrderBy('store_item_group_master','main_group_id','asc');
