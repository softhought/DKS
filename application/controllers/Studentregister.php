...

{
    ...
    {  
        ...
        $result['studentregisterdtl'] = $this->studentregistermodel->getstudentRegDtlsByBillingStyle($billing_style);
        ...
        { 
         ...
         $billing_style=$this->input->post('billing_style');
           ...
           $result['studentregisterdtl'] = $this->studentregistermodel->getstudentRegDtlsByBillingStyle($billing_style);
            ...
            $page = "dashboard/student-register/student_registration_list_partial_view";
  ...
  public function registration_action(){
      ...
      $session = $this->session->userdata('user_detail');
...

        {
           ...
           $dir = $_SERVER['DOCUMENT_ROOT'].'/assets/img/student-images';  //server
