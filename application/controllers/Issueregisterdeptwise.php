...
class Issueregisterdeptwise extends CI_Controller {
...
public function index()
{
  ...
  $session = $this->session->userdata('user_detail');
	...
	{  
          $page = "dashboard/inventory_master/reports/issue-register-dept-wise";
        $header="";       
       ...
       $result['departmentlist'] = $this->commondatamodel->getAllRecordWhereOrderBy('department_master_inv',[],'department_name');
...
public function issueregistedeptwiswreport()
{
    $session = $this->session->userdata('user_detail');
    if($this->session->userdata('user_detail'))
    {            
       ...
       $arrayParameter=[
            'form_date'=>"'". $frmDate."'",
            'to_date'=>"'". $toDt."'",
            'dept_id_'=>urldecode($this->uri->segment(5)),
            'YearId'=>$yearid ,
        ...
        $file= APPPATH."views/dashboard/reports/issue-register-dept-wise/IssueRegisterdeptWiseReport.jrxml";
