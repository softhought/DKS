$(document).ready(function() {
    ...
    $('#developmentfeestbtn').on('click', function(e) {
        ...
        var month_id = $("#sel_month").val();

        $("#categoryerr,#sel_montherr").removeClass("form_error");
...
$(document).on('click', ".delDevFees", function(e) {
  e.preventDefault();
  ...
  var checkstr =  confirm('are you sure you want to delete this?');
    if(checkstr == true){
     ...
     var devtranid=$(this).data("devtranid");
     var rowid=$(this).data("rowid");
        ...
        $("#load_"+rowid).css("display", "block")
           ...
           $.ajax({
           type: "POST",
           url: basepath+'deletedata/deleteDevelopmentFees',
           dataType: "json",
           contentType: "application/x-www-form-urlencoded; charset=UTF-8",
           data: {devtranid:devtranid},
