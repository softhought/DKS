$(document).ready(function() {
    ...
    //daily receipt register list
    /* ------------------------------------------------- */
    $(document).on('click', "#dailyreceiptlistshowbtn", function(e) {
        ...
        if (1) {
            ...
            $.ajax({
                type: "POST",
                url: basepath + 'dailyreceiptregister/getMemberReceiptListByDate',
                dataType: "html",
                data: { from_dt: from_dt, to_date: to_date, tran_type: tran_type,payment_id:payment_id },
                success: function(result) {
  ...
  var checkstr =  confirm('are you sure you want to delete this?');
    if(checkstr == true){
     ...
     var paymentid=$(this).data("paymentid");
           $.ajax({
           type: "POST",
           url: basepath+'deletedata/deleteMembersReceipt',
           dataType: "json",
           contentType: "application/x-www-form-urlencoded; charset=UTF-8",
