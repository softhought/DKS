$(document).ready(function() {
    ...
    $(document).on('click', "#purchaseprint", function(e) {
        e.preventDefault();
        var data = [];
        $(".rowCheck").each(function() {
            row = $(this).val();
        ...
        if (validatevender()) {
            ...
            var URL = basepath + "Purcharorederregister/purchaseorderregisterreport/" + fromdate + "/" + todate + "/" + encodeURIComponent(data.toString());
            var w = window.open(URL, '_blank');
            $(w.document).find('html').append('<head><title>Purchase Order Register</title></head>');
